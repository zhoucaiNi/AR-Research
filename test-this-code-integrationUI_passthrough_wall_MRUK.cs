...
public class WallSelectorUI : MonoBehaviour
{
    ...
    {
        if (currentWallIndex >= 0 && currentWallIndex < currentEffectMeshRenderers.Count)
        {
            Renderer renderer = currentEffectMeshRenderers[currentWallIndex];
